...
class _FileDescriptorLike(Protocol):
    def fileno(self) -> int: ...
...
class Loop:
    ...
    def add_reader(self, fd: int | _FileDescriptorLike, callback: Callable[..., object], *args: Any) -> None: ...
    def add_writer(self, fd: int | _FileDescriptorLike, callback: Callable[..., object], *args: Any) -> None: ...
    def remove_reader(self, fd: int | _FileDescriptorLike, /) -> bool: ...
    def remove_writer(self, fd: int | _FileDescriptorLike, /) -> bool: ...
    def _run(self) -> None: ...
